...
class DriveManager:
    ...
    def get_tools(self):
        tools = [
            Tool(
                name="upload_file_to_drive",
                description='Upload file to Google Drive. JSON: {"file_path": "str", "folder_id": "str", "file_name": "str"}',  # noqa
                func=lambda params: self.upload_file(
                    **(
                        params
            ...
            Tool(
                name="download_file_from_drive",
                description='Download file from Google Drive. JSON: {"file_id": "str", "file_name": "str", "local_path": "str"}',  # noqa
                func=lambda params: self.download_file(
                    **(
                        params
                        if isinstance(params, dict)
                        else __import__("json").loads(params)
            ...
            Tool(
                name="share_drive_file",
                description='Share file with users. JSON: {"file_id": "str", "emails": ["str"], "role": "str", "notify": true/false}',  # noqa
                func=lambda params: self.share_file(
                    **(
                        params
                        if isinstance(params, dict)
                        else __import__("json").loads(params)
            ...
            Tool(
                name="create_drive_folder",
                description='Create a new folder. JSON: {"folder_name": "str", "parent_folder_id": "str"}',  # noqa
                func=lambda params: self.create_folder(
                    **(
                        params
                        if isinstance(params, dict)
                        else __import__("json").loads(params)
            ...
            Tool(
                name="list_drive_files",
                description='List files in Drive. JSON: {"folder_id": "str", "file_type": "str", "max_results": int}',  # noqa
                func=lambda params: self.list_files(
                    **(
                        params
                        if isinstance(params, dict)
                        else __import__("json").loads(params)
            ...
            Tool(
                name="move_drive_file",
                description='Move file to different folder. JSON: {"file_id": "str", "destination_folder_id": "str"}',  # noqa
                func=lambda params: self.move_file(
                    **(
                        params
                        if isinstance(params, dict)
                        else __import__("json").loads(params)
